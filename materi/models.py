...
class Quiz(models.Model):
    ...
    kkm = models.IntegerField(default = 3)
...
class Question(models.Model):
    ...
    quiz_img = models.ImageField(upload_to='quiz_images', default=' ', blank=True, null=True, verbose_name='Quiz image')
    bobot_nilai = models.IntegerField(default=20, blank=True, null=True)  # Field bobot nilai boleh kosong dan boleh null dengan default 20
  
    def __str__(self):
        return f"{self.text1[:50]},{self.quiz_img}, {self.text2[:50]}"
...
class Choice(models.Model):
    ...
    def __str__(self):
        return f"{self.question.text1[:50]},{self.question.text2[:50]}, {self.text[:20]}"
